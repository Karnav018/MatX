        ...
        <div className="bg-matx-primary-800 rounded-xl p-6 sm:p-8 shadow-2xl border border-zinc-700">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end">
              <Link 
                to="/forgot-password" 
                className="text-sm text-matx-accent hover:text-matx-accent-dark transition-colors duration-200"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-matx-primary-800 text-matx-text-secondary">Or continue with</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button className="w-full inline-flex justify-center py-2.5 px-4 border border-zinc-600 rounded-lg bg-matx-primary-700 hover:bg-zinc-600 transition-colors duration-200">
          ...
          <p className="mt-6 text-center text-sm text-matx-text-secondary">
            ...
            <Link to="/register" className="text-matx-accent hover:text-matx-accent-dark font-medium transition-colors duration-200">
              Sign up here
            </Link>
          </p>
        </div>
